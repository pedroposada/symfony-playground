 ...
 * src/PSL/ClipperBundle/Charts/Assembler.php
 *
 * Direct test command:
 * phpunit -c app src/PSL/ClipperBundle/Tests/Charts/ChartsAssemblerTest.php
 *
 * Note:
 * Test sequence must be based on chart map orders.
 * @see  src/PSL/ClipperBundle/Charts/SurveyChartMap.php
 */
namespace PSL\ClipperBundle\Tests\Charts;
