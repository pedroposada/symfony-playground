<?php
/**
 * PSL/ClipperBundle/Survey/AdoptionSurvey.php
 * 
...
// ------------------------------------------------------------------------------
    ...
    $survey_language_settings_row = $templating->render('PSLClipperBundle:limesurvey:AdoptionSurveyAssets/adoptionSurveyLanguageSettings.xml.twig',
...
// ---------------------------------------------------------------------------------------------------------------------------
    ...
    $question_attribute_1_0_row_0 = $templating->render('PSLClipperBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_1_0,
