...
class LsResponsesCommand extends ContainerAwareCommand
{
  ...
  protected function execute(InputInterface $input, OutputInterface $output)
  {
    ...
    if ($input->getOption('fqgid') && $input->getOption('fqpid')) {
      $fqg = $em->getRepository('PSLClipperBundle:FirstQGroup')->find($input->getOption('fqgid'));
      $fqp = $em->getRepository('PSLClipperBundle:FirstQProject')->find($input->getOption('fqpid'));
      $items[] = array(
        'fqg' => $fqg,
        'fqp' => $fqp,
      );
