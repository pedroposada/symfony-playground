...
/**
 * file: PP\SampleBundle\Charts\Pdf\Types\NpsPlusPdf.php
 * service: clipper.charts.pdf.nps_plus
 * 
 * Create reports in pdf format for NPS Plus surveys
 **/

namespace PP\SampleBundle\Charts\Pdf\Types;
...
class NpsPlusPdf
{
  ...
  {
    // query order id
    $this->fqg = $this->em->getReference('PPSampleBundle:FirstQGroup', $event->getOrderId());
    // check for type
  ...
  /**
   * @param \PP\SampleBundle\Entity\FirstQGroup $fqg
   * 
  ...
  protected function getTemplateMap(FirstQGroup $fqg, $drilldown=array('region'=>'none'))
  {
    ...
    // Introduction
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/introduction.html.twig',
      'placeholders' => array(
    ...
    // Table of contents
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/tableofcontents.html.twig'
    ));
    // Get data
    $filters = array(
      'countries' => $countries
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart01.html.twig',
      'placeholders' => array(
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart02.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart03.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart04.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart05.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart06.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart07.html.twig',
      'placeholders' => array(
        'chart_datatable' => json_encode($datatable)
      )
    ));
    ...
    // // - Intro
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart08intro.html.twig',
      'placeholders' => array(
        'region' => $drilldown['region']
      )
    ));
    ...
    foreach ($formData['brands'] as $brandIdx => $brand) {
      ...
      $map->add(array(
        'twig' => 'PPSampleBundle:Charts:nps_plus/chart08.html.twig',
        'placeholders' => array(
          'chart_datatable' => json_encode($datatable),
    ...
    // - Intro
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/chart09intro.html.twig'
    ));
    // - Charts
    ...
    foreach ($countries as $marketIdx => $market) {
      ...
      foreach ($datatable as $brandIdx => $brand_datatable) {
        $map->add(array(
          'twig' => 'PPSampleBundle:Charts:nps_plus/chart09.html.twig',
          'placeholders' => array(
    ...
    // Appendix
    $map->add(array(
      'twig' => 'PPSampleBundle:Charts:nps_plus/appendix.html.twig'
    ));
