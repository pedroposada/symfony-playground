<?php
/**
 * PP/SampleBundle/Survey/LimeSurvey.php
 * 
 * Lime Survey Class
...
use PP\SampleBundle\Event\LimeSurveyTranslationEvent;
...
class LimeSurvey
{
  ...
  public function assembleSurvey()
  {
    ...
    $assembled_survey = $this->container->get('templating')->render('PPSampleBundle:limesurvey:limesurveyTemplate.xml.twig', $elements_array);
