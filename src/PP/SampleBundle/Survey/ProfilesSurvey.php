<?php
/**
 * PP/SampleBundle/Survey/ProfilesSurvey.php
 * 
...
// ---------------------------------------------------------------------------------------------------------------------------
    ...
    foreach ($this->brands as $key => $brand) {
      ...
      $answer_2_0_row_0 = $templating->render('PPSampleBundle:limesurvey:limesurveyAnswerRow.xml.twig', 
        array('qid' => $qid_2_0,
          'code' => 'A1',
          'answer' => 'Yes',
          'sortorder' => 1,
      ...
      $answer_2_0_row_1 = $templating->render('PPSampleBundle:limesurvey:limesurveyAnswerRow.xml.twig', 
        array('qid' => $qid_2_0,
          'code' => 'A2',
          'answer' => 'No',
          'sortorder' => 2,
      ...
      $condition_2_row = $templating->render('PPSampleBundle:limesurvey:limesurveyConditionRow.xml.twig', 
        array('cid' => $cid_2_0,
          'qid' => $qid_2_0,
      ...
      $question_attribute_2_0_row = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
        array('qid' => $qid_2_0,
          'attribute' => 'random_order',
          'value' => 1,
          'language' => '',
