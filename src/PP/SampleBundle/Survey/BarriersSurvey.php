<?php
/**
 * PP/SampleBundle/Survey/BarriersSurvey.php
 * 
 * Barriers Survey Class
 * Handles all business logic for an Barriers survey
...
class BarriersSurvey extends LimeSurvey
{
