<?php
/**
 * PP/SampleBundle/Survey/NPSPlusSurvey.php
 * 
 * NPS+ Survey Class
...
// ------------------------------------------------------------------------------
    ...
    $survey_language_settings_row = $templating->render('PPSampleBundle:limesurvey:NPSSurveyAssets/npsSurveyLanguageSettings.xml.twig',
...
// ---------------------------------------------------------------------------------------------------------------------------
    ...
    $question_attribute_0_0_row_0 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_0_0,
...
$(document).ready(function(){
  ...
  $(".question-wrapper input:radio").change(function(){
    ...
    $question_0_1_row = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionRow.xml.twig', 
      array('qid' => $qid_0_1,
        'parent_qid' => 0,
        'sid' => $sid,
        'gid' => $gid_0,
    ...
    $answer_0_1_row = $templating->render('PPSampleBundle:limesurvey:limesurveyAnswerRow.xml.twig', 
      array('qid' => $qid_0_1,
        'code' => 'A1',
        'answer' => 'yes',
        'sortorder' => 1,
...
$(document).ready(function(){
  ...
  $(".question-wrapper input:radio").change(function(){
    ...
    $question_0_2_row = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionRow.xml.twig', 
      array('qid' => $qid_0_2,
        'parent_qid' => 0,
        'sid' => $sid,
        'gid' => $gid_0,
    ...
    $answer_0_2_row = $templating->render('PPSampleBundle:limesurvey:limesurveyAnswerRow.xml.twig', 
      array('qid' => $qid_0_2,
        'code' => 'A1',
        'answer' => 'yes',
        'sortorder' => 1,
...
$(document).ready(function(){
    ...
    $question_0_3_row = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionRow.xml.twig', 
      array('qid' => $qid_0_3,
        'parent_qid' => 0,
        'sid' => $sid,
        'gid' => $gid_0,
    ...
    $answer_0_3_row = $templating->render('PPSampleBundle:limesurvey:limesurveyAnswerRow.xml.twig', 
      array('qid' => $qid_0_3,
        'code' => 'A1',
        'answer' => 'yes',
        'sortorder' => 1,
...
$(document).ready(function(){
  ...
  $("input").not(".readonly, input[type=\"hidden\"]").on("input", function(e) { 
    ...
    // top row
    $subquestion_1_0_row = $templating->render('PPSampleBundle:limesurvey:limesurveySubquestionRow.xml.twig', 
    ...
    $attributes_1_0_row_0 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_1_0,
    ...
    $attributes_1_0_row_1 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_1_0,
    ...
    $attributes_1_0_row_2 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_1_0,
        'attribute' => 'printable_help',
        'value' => 1,
        'language' => 'en',
...
// ---------------------------------------------------------------------------------------------------------------------------
    ...
    $group_2_row = $templating->render('PPSampleBundle:limesurvey:limesurveyGroupRow.xml.twig', 
      array('gid' => $gid_2,
        'sid' => $sid,
...
(function ($) {
  $(document).ready(function () {
    ...
    $question_2_0_row = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionRow.xml.twig', 
      array('qid' => $qid_2_0,
        'parent_qid' => 0,
        'sid' => $sid,
        'gid' => $gid_2,
    ...
    // top row
    $subquestion_2_0_row = $templating->render('PPSampleBundle:limesurvey:limesurveySubquestionRow.xml.twig', 
    ...
    $subquestion_2_1_row = $templating->render('PPSampleBundle:limesurvey:limesurveySubquestionRow.xml.twig', 
    ...
    $attributes_2_0_row_0 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_2_0,
        'attribute' => 'array_filter',
        'value' => 'G001Q004',
        'language' => '',
    ...
    $attributes_2_0_row_1 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_2_0,
        'attribute' => 'input_boxes',
        'value' => 1,
        'language' => '',
    ...
    $attributes_2_0_row_2 = $templating->render('PPSampleBundle:limesurvey:limesurveyQuestionAttributeRow.xml.twig', 
      array('qid' => $qid_2_0,
        'attribute' => 'printable_help',
        'value' => 1,
        'language' => 'en',
