<?php
/**
 * PP/SampleBundle/Controller/ClipperCacheService.php
 *
...
use PP\SampleBundle\Entity\Repository\ClipperCacheRepository;
use \DateTime;
...
class ClipperCacheService {
  ...
  public function __construct($params, $container) {
    ...
    if ($this->enabled) {
      ...
      $this->clipper_cache_rep = $this->em->getRepository('PPSampleBundle:ClipperCache');
    }
  }
