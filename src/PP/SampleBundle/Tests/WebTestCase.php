...
namespace PP\SampleBundle\Tests;
...
abstract class WebTestCase extends BaseWebTestCase
{
    ...
    protected function reloadFixture()
    {
        ...
        $this->loadFixtures(array(
            'PP\SampleBundle\DataFixtures\ORM\LoadFirstQGroups',
            'PP\SampleBundle\DataFixtures\ORM\LoadFirstQProjects',
            'PP\SampleBundle\DataFixtures\ORM\LoadLimeSurveyResponse',
        ));
    }
    ...
    public function getLatestFirstQGroup($survey_type, $order_status, $return_one = FALSE) {
      ...
      $group =  $em->getRepository("PPSampleBundle:FirstQGroup")->createQueryBuilder('fqg')
