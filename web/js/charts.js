...
var chartsdata = [
  {type: "net_promoters",   datatable: "some specific data here too"},
  {type: "what_they_say",   datatable: "some data here"}
];
...
// React.render(
  // // <CommentBox url="/clipper/debug" pollInterval={9999999999} />,
